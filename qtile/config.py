...
class Commands:
	...
	def get_ls_audacious(self):
		return check_output(['/home/phil/.config/tint2/scripts/audacious.sh']).decode("utf-8").replace("\n","")
commands = Commands()
        ...
        top=bar.Bar(
            [
                ...
                widget.TextBox(
                    ...
                    #colors[3],
                    foreground="#ff5c95",
                    mouse_callbacks={'Button1': lambda: qtile.cmd_spawn("lxterminal -e '~/.config/rofi/launchers/colorful/launcher.sh'")},
                    ),
                widget.TextBox(
                    text='\ue0be',
                    font="Inconsolata for powerline",
              ...
              #  ),
               ...
               widget.TextBox(
                ...
                widget.TextBox(
                    ...
                    #colors[12],
                    padding=0,
                    mouse_callbacks={'Button1': lambda: qtile.cmd_spawn("lxterminal -e 'feh --bg-fill --randomize ~/Pictures/wallpapers/*'")},
	           ...
	           # mouse_callbacks={'Button1': lambda: qtile.cmd_spawn("st -e storage.sh")},
                ...
                widget.Volume(
                    ...
                    font="Inconsolata for powerline",
                    fontsize=18,
                    mouse_callbacks={'Button3': lambda: qtile.cmd_spawn("lxterminal -e pulsemixer")},
                ),
               ...
               # foreground=colors[0],
                ...
                widget.GenPollText(
                    ...
                    fontsize='15',
                    #mouse_callbacks={'Button1' : openweather},
                    func = commands.get_ls_audacious,
                    update_interval=1,
                    background = colors[12],
                    foreground = colors[10],
                   mouse_callbacks={'Button1': lambda: qtile.cmd_spawn('audtool --playback-playpause')},
                    #mouse_callbacks={'Button1': open_weather},
                    ),
